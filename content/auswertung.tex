...
%\begin{equation*}
  %\begin{split}
  %  \increment \nu_{\text{1/2,theo}} = \pm \frac{1}{2\pi} &\sqrt{
  %  \left(\left(\frac{R}{4L^2\sqrt{\frac{R^2}{4L^2} +\frac{1}{LC}}}\pm \frac{1}{2L}\right) \, \increment R \right)^2
  %  + \left(\frac{1}{2R\sqrt{LC}}\, \increment L \right)^2} \\
  %  &\overline{ +\left(\frac{-\sqrt{L}}{2RC^{\frac{3}{2}}}\, \increment C \right)^2}
  %\end{split}
\begin{equation*}
